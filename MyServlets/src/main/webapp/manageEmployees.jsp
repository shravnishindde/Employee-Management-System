...
<%
    ...
    // Fetch employee data from Emp table
    PreparedStatement empStmt = conn.prepareStatement("SELECT * FROM Emp");
...
<div class="navbar">
     ...
     <div class="main-container">
        ...
        <table class="glass-table">
            ...
            <% while (empRs.next()) { %>
            <tr>
                <td><%= empRs.getInt("e_id") %></td>
                <td><%= empRs.getString("e_name") %></td>
                <td><%= empRs.getString("emp_mail") %></td>
                <td><%= empRs.getString("emp_unm") %></td>
                <td><%= empRs.getString("emp_phn") %></td>
                <td><%= empRs.getString("emp_add") %></td>
                <td>
                   <a href="updateEmployee.jsp?e_id=<%= empRs.getInt("e_id") %>" class="btn">Edit</a> 
                   <a href="deleteEmployee.jsp?e_id=<%= empRs.getInt("e_id") %>" class="btn delete-btn"
